...
@deffield    modified: April 14th 2018
@deffield    modified_by: Brian Bennett
@deffield    mod_contact: brian <AT> ohheybrian.com
...
def fileToItem(host, fname, pubDate):
    ...
    #     tagParams = "url=\"{0}\" type=\"{1}\" length=\"{2}\"".format(fileURL, os.path.getsize(fname))
    #
